...
void damageCalculator(main::axie &attacker, main::axie &defender, main::card &playedCards){
    int damage = 100;
...
void battle(main::player &p1, main::player &p2){
